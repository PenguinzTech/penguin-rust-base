// PATCHED by penguin-rust-base: null guards in CheckPanelAvailability, LoadPanels, InitializeGUI, DestroyGUI to handle missing Docks/Panels from stale pre-v1.0.9 config schema
using System;
